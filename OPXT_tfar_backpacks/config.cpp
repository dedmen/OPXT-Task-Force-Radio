...
class cfgPatches {
  class OPXT_TFAR_ITEMS {
    ...
    requiredAddons[] = {"A3_Modules_F","A3_UI_F","A3_Structures_F_Items_Electronics","A3_Weapons_F_ItemHolders","cba_main","cba_ui","cba_xeh","cba_settings","tfar_core","tfar_backpacks"};
    requiredVeslion = 0.1;
    units[] = {};
    weapons[] = {};
  };
